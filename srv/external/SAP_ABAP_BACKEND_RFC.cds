/* checksum : 6a610e7d0d40ebc9fca5b004885c2ee6 */
@cds.external: true
@protocol    : 'rfc'
service SAP_ABAP_BACKEND_RFC {
  action BAPI_USER_GETLIST(
                           ...
                           @RFCParameterType: 'Table'
                           SELECTION_EXP: many DDIC.BAPIUSSEXP,
                           @RFCParameterType: 'Table'
                           SELECTION_RANGE: many DDIC.BAPIUSSRGE,
                           @RFCParameterType: 'Table'
                           USERLIST: many DDIC.BAPIUSNAME)               returns BAPI_USER_GETLIST.ResultType;
  ...
  action BAPI_USER_GET_DETAIL(
                              ...
                              @RFCParameterType: 'Import'
                              EXTUID_GET: DDIC.BAPIEXTUIDGET,
                              @RFCParameterType: 'Import'
                              USERNAME: String(12) not null,
                              @RFCParameterType: 'Table'
                              ACTIVITYGROUPS: many DDIC.BAPIAGR,
                              @RFCParameterType: 'Table'
                              ADDCOMREM: many DDIC.BAPICOMREM,
                              @RFCParameterType: 'Table'
                              ADDFAX: many DDIC.BAPIADFAX,
                              @RFCParameterType: 'Table'
                              ADDPAG: many DDIC.BAPIADPAG,
                              @RFCParameterType: 'Table'
                              ADDPRT: many DDIC.BAPIADPRT,
                              @RFCParameterType: 'Table'
                              ADDRFC: many DDIC.BAPIADRFC,
                              @RFCParameterType: 'Table'
                              ADDRML: many DDIC.BAPIADRML,
                              @RFCParameterType: 'Table'
                              ADDSMTP: many DDIC.BAPIADSMTP,
                              @RFCParameterType: 'Table'
                              ADDSSF: many DDIC.BAPIADSSF,
                              @RFCParameterType: 'Table'
                              ADDTEL: many DDIC.BAPIADTEL,
                              @RFCParameterType: 'Table'
                              ADDTLX: many DDIC.BAPIADTLX,
                              @RFCParameterType: 'Table'
                              ADDTTX: many DDIC.BAPIADTTX,
                              @RFCParameterType: 'Table'
                              ADDURI: many DDIC.BAPIADURI,
                              @RFCParameterType: 'Table'
                              ADDX400: many DDIC.BAPIADX400,
                              @RFCParameterType: 'Table'
                              EXTIDHEAD: many DDIC.BAPIUSEXTIDHEAD,
                              @RFCParameterType: 'Table'
                              EXTIDPART: many DDIC.BAPIUSEXTIDPART,
                              @RFCParameterType: 'Table'
                              EXTUID: many DDIC.BAPIEXTUID,
                              @RFCParameterType: 'Table'
                              GROUPS: many DDIC.BAPIGROUPS,
                              @RFCParameterType: 'Table'
                              PARAMETER: many DDIC.BAPIPARAM,
                              @RFCParameterType: 'Table'
                              PARAMETER1: many DDIC.BAPIPARAM1,
                              @RFCParameterType: 'Table'
                              PROFILES: many DDIC.BAPIPROF,
                              @RFCParameterType: 'Table'
                              RETURN: many DDIC.BAPIRET2,
                              @RFCParameterType: 'Table'
                              SAPUSER_UUID_HIST: many DDIC.BAPIUSERUUIDHIST,
                              @RFCParameterType: 'Table'
                              SYSTEMS: many DDIC.BAPIRCVSYS,
                              @RFCParameterType: 'Table'
                              UCLASSSYS: many DDIC.BAPIUCLASSSYS,
                              @RFCParameterType: 'Table'
                              USATTRIBUTE: many DDIC.BAPIUSATTRIBUTE)    returns BAPI_USER_GET_DETAIL.ResultType;
  ...
  type BAPI_USER_GET_DETAIL.ResultType {
    ...
    @RFCParameterType: 'Export'
    ADMINDATA         : DDIC.BAPIUSERADMIN;

    @RFCParameterType: 'Export'
    ALIAS             : DDIC.BAPIALIAS;

    @RFCParameterType: 'Export'
    COMPANY           : DDIC.BAPIUSCOMP;

    @RFCParameterType: 'Export'
    DEFAULTS          : DDIC.BAPIDEFAUL;

    @RFCParameterType: 'Export'
    DESCRIPTION       : DDIC.BAPIUSDESC;

    @RFCParameterType: 'Export'
    IDENTITY          : DDIC.BAPIIDENTITY;

    @RFCParameterType: 'Export'
    ISLOCKED          : DDIC.BAPISLOCKD;

    @RFCParameterType: 'Export'
    LASTMODIFIED      : DDIC.BAPIMODDAT;

    @RFCParameterType: 'Export'
    LOGONDATA         : DDIC.BAPILOGOND;

    @RFCParameterType: 'Export'
    REF_USER          : DDIC.BAPIREFUS;

    @RFCParameterType: 'Export'
    SAPUSER_UUID      : DDIC.BAPIUSERUUID;

    @RFCParameterType: 'Export'
    SNC               : DDIC.BAPISNCU;

    @RFCParameterType: 'Export'
    TECH_USER         : DDIC.BAPITECHUSER;

    @RFCParameterType: 'Export'
    UCLASS            : DDIC.BAPIUCLASS;
    ...
    @RFCParameterType: 'Table'
    USATTRIBUTE       : many DDIC.BAPIUSATTRIBUTE;
  };

  action BAPI_SALESORDER_SIMULATE(
                                  @RFCParameterType: 'Import'
                                  CONVERT_PARVW_AUART: String(1) default 'SPACE',
                                  @RFCParameterType: 'Import'
                                  ORDER_HEADER_IN: DDIC.BAPISDHEAD not null,
                                  @RFCParameterType: 'Table'
                                  EXTENSIONIN: many DDIC.BAPIPAREX,
                                  @RFCParameterType: 'Table'
                                  MESSAGETABLE: many DDIC.BAPIRET2,
                                  @RFCParameterType: 'Table'
                                  ORDER_CCARD: many DDIC.BAPICCARD,
                                  @RFCParameterType: 'Table'
                                  ORDER_CCARD_EX: many DDIC.BAPICCARD_EX,
                                  @RFCParameterType: 'Table'
                                  ORDER_CFGS_BLOB: many DDIC.BAPICUBLB,
                                  @RFCParameterType: 'Table'
                                  ORDER_CFGS_INST: many DDIC.BAPICUINS,
                                  @RFCParameterType: 'Table'
                                  ORDER_CFGS_PART_OF: many DDIC.BAPICUPRT,
                                  @RFCParameterType: 'Table'
                                  ORDER_CFGS_REF: many DDIC.BAPICUCFG,
                                  @RFCParameterType: 'Table'
                                  ORDER_CFGS_VALUE: many DDIC.BAPICUVAL,
                                  @RFCParameterType: 'Table'
                                  ORDER_CONDITION_EX: many DDIC.BAPICOND,
                                  @RFCParameterType: 'Table'
                                  ORDER_INCOMPLETE: many DDIC.BAPIINCOMP,
                                  @RFCParameterType: 'Table'
                                  ORDER_ITEMS_IN: many DDIC.BAPIITEMIN,
                                  @RFCParameterType: 'Table'
                                  ORDER_ITEMS_OUT: many DDIC.BAPIITEMEX,
                                  @RFCParameterType: 'Table'
                                  ORDER_PARTNERS: many DDIC.BAPIPARTNR,
                                  @RFCParameterType: 'Table'
                                  ORDER_SCHEDULE_EX: many DDIC.BAPISDHEDU,
                                  @RFCParameterType: 'Table'
                                  ORDER_SCHEDULE_IN: many DDIC.BAPISCHDL,
                                  @RFCParameterType: 'Table'
                                  PARTNERADDRESSES: many DDIC.BAPIADDR1) returns BAPI_SALESORDER_SIMULATE.ResultType;

  type BAPI_SALESORDER_SIMULATE.ResultType {
    @RFCParameterType: 'Export'
    BILLING_PARTY      : DDIC.BAPIPAYER;
    ...
    @RFCParameterType: 'Export'
    SHIP_TO_PARTY      : DDIC.BAPISHIPTO;

    @RFCParameterType: 'Export'
    SOLD_TO_PARTY      : DDIC.BAPISOLDTO;
    ...
    @RFCParameterType: 'Table'
    PARTNERADDRESSES   : many DDIC.BAPIADDR1;
  };

  action BAPI_INQUIRY_CREATEFROMDATA2(
                                      @RFCParameterType: 'Import'
                                      ...
                                      @RFCParameterType: 'Import'
                                      INQUIRY_HEADER_IN: DDIC.BAPISDHD1 not null,
                                      @RFCParameterType: 'Import'
                                      INQUIRY_HEADER_INX: DDIC.BAPISDHD1X,
                                      @RFCParameterType: 'Import'
                                      INT_NUMBER_ASSIGNMENT: String(1),
                                      @RFCParameterType: 'Import'
                                      LOGIC_SWITCH: DDIC.BAPISDLS,
                                      @RFCParameterType: 'Import'
                                      SALESDOCUMENTIN: String(10),
                                      @RFCParameterType: 'Import'
                                      SENDER: DDIC.BAPI_SENDER,
                                      @RFCParameterType: 'Import'
                                      TESTRUN: String(1),
                                      @RFCParameterType: 'Table'
                                      EXTENSIONEX: many DDIC.BAPIPAREX,
                                      @RFCParameterType: 'Table'
                                      EXTENSIONIN: many DDIC.BAPIPAREX,
                                      @RFCParameterType: 'Table'
                                      INQUIRY_CFGS_BLOB: many DDIC.BAPICUBLB,
                                      @RFCParameterType: 'Table'
                                      INQUIRY_CFGS_INST: many DDIC.BAPICUINS,
                                      @RFCParameterType: 'Table'
                                      INQUIRY_CFGS_PART_OF: many DDIC.BAPICUPRT,
                                      @RFCParameterType: 'Table'
                                      INQUIRY_CFGS_REF: many DDIC.BAPICUCFG,
                                      @RFCParameterType: 'Table'
                                      INQUIRY_CFGS_REFINST: many DDIC.BAPICUREF,
                                      @RFCParameterType: 'Table'
                                      INQUIRY_CFGS_VALUE: many DDIC.BAPICUVAL,
                                      @RFCParameterType: 'Table'
                                      INQUIRY_CFGS_VK: many DDIC.BAPICUVK,
                                      @RFCParameterType: 'Table'
                                      INQUIRY_CONDITIONS_IN: many DDIC.BAPICOND,
                                      @RFCParameterType: 'Table'
                                      INQUIRY_CONDITIONS_INX: many DDIC.BAPICONDX,
                                      @RFCParameterType: 'Table'
                                      INQUIRY_ITEMS_IN: many DDIC.BAPISDITM,
                                      @RFCParameterType: 'Table'
                                      INQUIRY_ITEMS_INX: many DDIC.BAPISDITMX,
                                      @RFCParameterType: 'Table'
                                      INQUIRY_KEYS: many DDIC.BAPISDKEY,
                                      @RFCParameterType: 'Table'
                                      INQUIRY_PARTNERS: many DDIC.BAPIPARNR,
                                      @RFCParameterType: 'Table'
                                      INQUIRY_SCHEDULES_IN: many DDIC.BAPISCHDL,
                                      @RFCParameterType: 'Table'
                                      INQUIRY_SCHEDULES_INX: many DDIC.BAPISCHDLX,
                                      @RFCParameterType: 'Table'
                                      INQUIRY_TEXT: many DDIC.BAPISDTEXT,
                                      @RFCParameterType: 'Table'
                                      PARTNERADDRESSES: many DDIC.BAPIADDR1,
                                      @RFCParameterType: 'Table'
                                      RETURN: many DDIC.BAPIRET2)        returns BAPI_INQUIRY_CREATEFROMDATA2.ResultType;

  type BAPI_INQUIRY_CREATEFROMDATA2.ResultType {
    @RFCParameterType: 'Export'
    SALESDOCUMENT          : String(10);
  ...
  action BAPI_SALESORDER_CREATEFROMDAT2(
                                        ...
                                        @RFCParameterType: 'Import'
                                        ORDER_HEADER_IN: DDIC.BAPISDHD1 not null,
                                        @RFCParameterType: 'Import'
                                        ORDER_HEADER_INX: DDIC.BAPISDHD1X,
                                        @RFCParameterType: 'Import'
                                        SALESDOCUMENTIN: String(10),
                                        @RFCParameterType: 'Import'
                                        SENDER: DDIC.BAPI_SENDER,
                                        ...
                                        ORDER_CFGS_REF: many DDIC.BAPICUCFG,
                                        @RFCParameterType: 'Table'
                                        ORDER_CFGS_REFINST: many DDIC.BAPICUREF,
                                        @RFCParameterType: 'Table'
                                        ORDER_CFGS_VALUE: many DDIC.BAPICUVAL,
                                        @RFCParameterType: 'Table'
                                        ORDER_CFGS_VK: many DDIC.BAPICUVK,
                                        @RFCParameterType: 'Table'
                                        ORDER_CONDITIONS_IN: many DDIC.BAPICOND,
                                        @RFCParameterType: 'Table'
                                        ORDER_CONDITIONS_INX: many DDIC.BAPICONDX,
                                        @RFCParameterType: 'Table'
                                        ORDER_ITEMS_IN: many DDIC.BAPISDITM,
                                        @RFCParameterType: 'Table'
                                        ORDER_ITEMS_INX: many DDIC.BAPISDITMX,
                                        @RFCParameterType: 'Table'
                                        ORDER_KEYS: many DDIC.BAPISDKEY,
                                        @RFCParameterType: 'Table'
                                        ORDER_PARTNERS: many DDIC.BAPIPARNR,
                                        @RFCParameterType: 'Table'
                                        ORDER_SCHEDULES_IN: many DDIC.BAPISCHDL,
                                        @RFCParameterType: 'Table'
                                        ORDER_SCHEDULES_INX: many DDIC.BAPISCHDLX,
                                        @RFCParameterType: 'Table'
                                        ORDER_TEXT: many DDIC.BAPISDTEXT,
                                        @RFCParameterType: 'Table'
                                        PARTNERADDRESSES: many DDIC.BAPIADDR1,
                                        @RFCParameterType: 'Table'
                                        RETURN: many DDIC.BAPIRET2)      returns BAPI_SALESORDER_CREATEFROMDAT2.ResultType;

  type BAPI_SALESORDER_CREATEFROMDAT2.ResultType {
    @RFCParameterType: 'Export'
    SALESDOCUMENT        : String(10);
  ...
  action BAPI_QUOTATION_GETDETAILBOS(
                                     @RFCParameterType: 'Import'
                                     ...
                                     @RFCParameterType: 'Table'
                                     QUOTATIONADDRESS: many DDIC.BAPISDCOAD,
                                     @RFCParameterType: 'Table'
                                     QUOTATIONBILLINGDATES: many DDIC.BAPISDBPLD,
                                     @RFCParameterType: 'Table'
                                     QUOTATIONBILLINGPLANS: many DDIC.BAPISDBPL,
                                     @RFCParameterType: 'Table'
                                     QUOTATIONBUSINESS: many DDIC.BAPISDBUSI,
                                     @RFCParameterType: 'Table'
                                     QUOTATIONCFGSCUBLBS: many DDIC.BAPICUBLBM,
                                     @RFCParameterType: 'Table'
                                     QUOTATIONCFGSCUCFGS: many DDIC.BAPICUCFGM,
                                     @RFCParameterType: 'Table'
                                     QUOTATIONCFGSCUINS: many DDIC.BAPICUINSM,
                                     @RFCParameterType: 'Table'
                                     QUOTATIONCFGSCUPRTS: many DDIC.BAPICUPRTM,
                                     @RFCParameterType: 'Table'
                                     QUOTATIONCFGSCUREFS: many DDIC.BAPICUREFM,
                                     @RFCParameterType: 'Table'
                                     QUOTATIONCFGSCUVALS: many DDIC.BAPICUVALM,
                                     @RFCParameterType: 'Table'
                                     QUOTATIONCFGSCUVKS: many DDIC.BAPICUVKM,
                                     @RFCParameterType: 'Table'
                                     QUOTATIONCONDHEAD: many DDIC.BAPICONDHD,
                                     @RFCParameterType: 'Table'
                                     QUOTATIONCONDITEM: many DDIC.BAPICONDIT,
                                     @RFCParameterType: 'Table'
                                     QUOTATIONCONDITIONS: many DDIC.BAPISDCOND,
                                     @RFCParameterType: 'Table'
                                     QUOTATIONCONDQTYSCALE: many DDIC.BAPICONDQS,
                                     @RFCParameterType: 'Table'
                                     QUOTATIONCONDVALSCALE: many DDIC.BAPICONDVS,
                                     @RFCParameterType: 'Table'
                                     QUOTATIONCONTRACTS: many DDIC.BAPISDCNTR,
                                     @RFCParameterType: 'Table'
                                     QUOTATIONCREDITCARDS: many DDIC.BAPICCARDM,
                                     @RFCParameterType: 'Table'
                                     QUOTATIONFLOWS: many DDIC.BAPISDFLOW,
                                     @RFCParameterType: 'Table'
                                     QUOTATIONITEMS: many DDIC.BAPISDITBOS,
                                     @RFCParameterType: 'Table'
                                     QUOTATIONPARTNERS: many DDIC.BAPISDPART,
                                     @RFCParameterType: 'Table'
                                     QUOTATIONSCHEDULELINES: many DDIC.BAPISDHEDU,
                                     @RFCParameterType: 'Table'
                                     QUOTATIONSERVICES: many DDIC.BAPISDESLLBOS,
                                     @RFCParameterType: 'Table'
                                     QUOTATIONSERVICESCOND: many DDIC.BAPIBOSCD,
                                     @RFCParameterType: 'Table'
                                     QUOTATIONSERVICESCOST: many DDIC.BAPIBOSCOST,
                                     @RFCParameterType: 'Table'
                                     QUOTATIONSERVICESTEXT: many DDIC.BAPIESLLTX,
                                     @RFCParameterType: 'Table'
                                     QUOTATIONSTATUSHEADERS: many DDIC.BAPISDHDST,
                                     @RFCParameterType: 'Table'
                                     QUOTATIONSTATUSITEMS: many DDIC.BAPISDITST,
                                     @RFCParameterType: 'Table'
                                     QUOTATIONTEXTHEADERS: many DDIC.BAPISDTEHD,
                                     @RFCParameterType: 'Table'
                                     QUOTATIONTEXTLINES: many DDIC.BAPITEXTLI,
                                     @RFCParameterType: 'Table'
                                     RETURN: many DDIC.BAPIRET2)         returns BAPI_QUOTATION_GETDETAILBOS.ResultType;

  type BAPI_QUOTATION_GETDETAILBOS.ResultType {
    @RFCParameterType: 'Export'
    QUOTATIONHEADER        : DDIC.BAPISDHD;
  ...
  action RSAU_API_GET_LOG_DATA(
                               @RFCParameterType: 'Import'
                               IS_INTERVAL: DDIC.RSAU_SEL_INTV not null,
                               @RFCParameterType: 'Import'
                               IT_R_INSTANCE: DDIC.RSDSSELOPT_T,
                               @RFCParameterType: 'Import'
                               IT_R_MANDT: DDIC.AUT_T_MANDT_RANGE,
                               @RFCParameterType: 'Import'
                               IT_R_MSG: DDIC.RSAU_SEL_OPT_T_EVTS,
                               @RFCParameterType: 'Import'
                               IT_R_REPS: DDIC.AUT_T_PROGN_RANGE,
                               @RFCParameterType: 'Import'
                               IT_R_TCD: DDIC.AUT_T_TCODE_RANGE,
                               @RFCParameterType: 'Import'
                               IT_R_USER: DDIC.SUSR_T_RANGE_4_XUBNAME)   returns RSAU_API_GET_LOG_DATA.ResultType;

  type RSAU_API_GET_LOG_DATA.ResultType {
    @RFCParameterType: 'Export'
    ET_FSTAT   : DDIC.RSAU_T_FILE_INFO;

    @RFCParameterType: 'Export'
    ET_LOG     : DDIC.RSAU_T_RESULT;

    @RFCParameterType: 'Export'
    ET_LOG_UTC : DDIC.RSAU_T_RESULT_UTC;

    @RFCParameterType: 'Export'
    ET_RETURN  : DDIC.BAPIRET2_T;
  };

  action USER_NAME_GET()                                                 returns USER_NAME_GET.ResultType;

  type USER_NAME_GET.ResultType {
    /** Internet User Alias */
    @RFCParameterType: 'Export'
    ALIASNAME      : String(40);
  ...
  type DDIC.BAPIUSCOMP {
    COMPANY          : String(42);
    TEMPLATE_ORGTYPE : String(1);
  };

  type DDIC.BAPIDEFAUL {
    STCOD      : String(20);
    SPLD       : String(4);
    SPLG       : String(1);
    SPDB       : String(1);
  ...
  type DDIC.BAPIUSDESC {
    RESPONSIBLE : String(12);
    TECHDESC    : String(80);
  };

  type DDIC.BAPIIDENTITY {
  ...
  type DDIC.BAPIEXTUID {
    EXTUID_TYPE : String(2);
    EXTUID      : String(241);
  };

  type DDIC.BAPIGROUPS {
    USERGROUP : String(12);
  };
  ...
  type DDIC.BAPIUSERUUIDHIST {
    SAP_UID : String(36);
  };

  type DDIC.BAPIRCVSYS {
    SUBSYSTEM : String(10);
  };

  type DDIC.BAPIUCLASSSYS {
    RCVSYSTEM         : String(10);
    LIC_TYPE          : String(2);
    SPEC_VERS         : String(2);
    COUNTRY_SURCHARGE : Decimal;
  ...
  type DDIC.BAPIUSATTRIBUTE {
    ATTR_TYPE : String(10);
    ATTR_ID   : String(20);
    ATTR_TEXT : String(60);
  };

  type DDIC.BAPISDHEAD {
  ...
  type DDIC.AUT_T_MANDT_RANGE      : many {
    SIGN   : String(1);
    OPTION : String(2);
    LOW    : String(3);
    HIGH   : String(3);
  ...
  type DDIC.RSAU_SEL_OPT_T_EVTS    : many {
    SIGN   : String(1);
    OPTION : String(2);
    LOW    : String(3);
    HIGH   : String(3);
  ...
  type DDIC.AUT_T_PROGN_RANGE      : many {
    SIGN   : String(1);
    OPTION : String(2);
    LOW    : String(40);
    HIGH   : String(40);
  ...
  type DDIC.AUT_T_TCODE_RANGE      : many {
    SIGN   : String(1);
    OPTION : String(2);
    LOW    : String(20);
    HIGH   : String(20);
  ...
  type DDIC.SUSR_T_RANGE_4_XUBNAME : many {
    SIGN   : String(1);
    OPTION : String(2);
    LOW    : String(12);
    HIGH   : String(12);
  ...
  type DDIC.RSAU_T_FILE_INFO       : many {
    @RFCAbapType: 'N'
    FILENO         : String(6);
    INSTNAME       : String(20);
  ...
  type DDIC.RSAU_T_RESULT          : many {
    ...
    SLGDATTIM  : String(16);
    LOG_TSTMP  : Decimal;
    CTAB       : DDIC.RSAU_T_COLOR;
  };

  type DDIC.RSAU_T_COLOR           : many {
    FIELDNAME : String(30);
    COLOR     : DDIC.RSAU_S_COLOR_SUBSET;
    NOKEYCOL  : String(1);
  };

  type DDIC.RSAU_S_COLOR_SUBSET {
    COL : Integer;
    INT : Integer;
    INV : Integer;
  };

  type DDIC.RSAU_T_RESULT_UTC      : many {
    SID        : String(8);
    INSTANCE   : String(40);
    SAL_DATE   : Date;
    SAL_TIME   : Time;
